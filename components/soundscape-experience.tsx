  ...
  return (
    <main ref={rootRef} className="soundscape-shell">
      ...
      <section ref={heroRef} className="hero-field" id="top">
        <Image className="hero-field-image" src="/media/brand/landscape.jpg" alt="Logo oficial de SoundScape sobre un paisaje" fill priority fetchPriority="high" sizes="100vw" />
